...
template = """
    ...
    1. A(n) [NOUN_1] may not [VERB_1] a [NOUN_2] or, through inaction, allow a
       [NOUN_2] to be [VERB_1P].

    2. A(n) [NOUN_1] must obey [PLURAL NOUN_1] given it by [NOUN_2P] except
       where such [PLURAL NOUN_1] would conflict with the First Law.

    3. A(n) [NOUN_1] must [VERB_2] its own [NOUN_4] as long as such [VERB_2]
